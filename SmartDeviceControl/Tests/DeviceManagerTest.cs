    ...
    public class DeviceManagerTest
    {
        ...
        public void Test_AddDevice_ShouldAddDevice()
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                Assert.IsTrue(sw.ToString().Contains("Galaxy Watch"));
            }
        }
        ...
        public void Test_RemoveDevice_ShouldRemoveDevice()
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                Console.SetOut(sw);
                deviceManager.ShowAllDevices();
                Assert.IsFalse(sw.ToString().Contains("Apple Watch SE2"));
            }
        }
        ...
        public void Test_EditDevice_ShouldChangeName()
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                Console.SetOut(sw);
                deviceManager.ShowAllDevices();
                Assert.IsTrue(sw.ToString().Contains("NewLinuxPC"));
                Assert.IsFalse(sw.ToString().Contains("LinuxPC"));
            }
        }
        ...
        public void Test_TurnOnDevice_ShouldTurnOn()
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                Console.SetOut(sw);
                deviceManager.ShowAllDevices();
                Assert.IsTrue(sw.ToString().Contains("Status: Open"));
            }
        }
        ...
        public void Test_TurnOffDevice_ShouldTurnOff()
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                Console.SetOut(sw);
                deviceManager.ShowAllDevices();
                Assert.IsTrue(sw.ToString().Contains("Status: Close"));
            }
        }
        ...
        public void Test_SaveData_ShouldWriteToFile()
        {
            ...
            Assert.IsTrue(lines[2].Contains("NewThinkPad"));
        }
    }
}
